...
$pdf ->Cell('C',7,'LAPORAN DATA DIRI SISWA',0,1,'C');
$pdf ->Cell(10,7,'',0,1);
$pdf ->SetFont('Arial','B',12);
$pdf ->Cell('L',7,'Profil Siswa :',0,1,'L');
...
$query=mysqli_query($koneksi, "SELECT * FROM siswa WHERE kd_siswa='$kd_siswa' ")or die(mysqli_error());
while($data=mysqli_fetch_array($query)){
	$pdf ->Cell(28,13,'  NIS',0,0);
	$pdf ->Cell(5,13,'  :',0,0);
	$pdf ->Cell(28,13,  $data['nis'],0,1);
	$pdf ->Cell(28,13,'  Nama Siswa',0,0);
	$pdf ->Cell(5,13,'  :',0,0);
	$pdf ->Cell(28,13,  $data['nama_siswa'],0,1);
	...
	$pdf ->Cell(28,13,'  Angkatan',0,0);
	$pdf ->Cell(5,13,'  :',0,0);
	$pdf ->Cell(28,13,  $data['angkatan'],0,1);
	$pdf ->Cell(28,13,'  Foto',0,0);
	$pdf ->Cell(5,13,'  :',0,0);
	$pdf ->Image('../../../assets/img/Data/Siswa/'.$data['foto'],47,175,50,60);
