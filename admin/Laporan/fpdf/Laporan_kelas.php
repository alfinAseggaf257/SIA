...
$pdf ->Cell('C',7,'LAPORAN DATA KELAS',0,1,'C');
...
$pdf ->Cell(44,13,'  Kode Kelas',1,0);
$pdf ->Cell(44,13,'  Nama Kelas',1,0);
$pdf ->Cell(34,13,'  Tahun Ajaran',1,0);
...
$query=mysqli_query($koneksi, "SELECT * FROM kelas 
	...
	ORDER BY nama_kelas ASC ")or die(mysqli_error());
while($data=mysqli_fetch_array($query)){
	$pdf ->Cell(13,7,$no,1,0);
	$pdf ->Cell(44,7,$data['kd_kelas'],1,0);
	$pdf ->Cell(44,7,$data['nama_kelas'],1,0);
	$pdf ->Cell(34,7,$data['tahun_ajaran'],1,0);
	$pdf ->Cell(54,7,$data['nama_guru'],1,1);
