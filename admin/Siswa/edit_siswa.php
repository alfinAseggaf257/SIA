	...
	<div class="container-fluid px-4">
		...
		<div class="col-lg-12">
			<div class="card rounded formtambah">
				...
				<br>
				<div class="container">
					<form action="?page=update_siswa" method="POST" enctype="multipart/form-data">
						<div class="container" style="margin-left: 2%;">
							...
							<div class="mb-2 row">
								...
								<div class="col-sm-4">
									<input type="text" name="angkatan" autocomplete="off" value="<?= $data['angkatan'] ?>" class="form-control" id="alamat" required>
								</div>
							</div>
							<div class="mb-2 row">
