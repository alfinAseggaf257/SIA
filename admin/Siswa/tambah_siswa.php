<?php 
require '../connect.php'; 	
$query 		 = mysqli_query($koneksi,"SELECT max(kd_siswa) FROM siswa") or die(mysql_error());
$data 		 = mysqli_fetch_array($query);
if($data){
	$no   	 = substr($data[0],2);
	$kode 	 = (int) $no;
	$kode 	 = $kode+1;
	$kode_acak= "SW".str_pad($kode,3,"0", STR_PAD_LEFT);
	...
	<div class="container-fluid px-4">
		...
		<div class="col-lg-12">
			<div class="card rounded formtambah">
				...
				<br>
				<div class="container">
					<form action="?page=simpan_siswa" method="POST" enctype="multipart/form-data">
						<div class="container" style="margin-left: 2%;">	
							<div class="mb-2 row" hidden>
								<label for="kd_siswa" class="col-sm-2 col-form-label">Kode Siswa<span class="text-danger">*</span></label>
								<div class="col-sm-4">
									<input type="text" name="kd_siswa" class="form-control" value="<?php echo $kode_acak; ?>" id="kd_siswa" readonly>
								</div>
							</div>						
							<div class="mb-2 row">
								<label for="nis" class="col-sm-2 col-form-label">NIS<span class="text-danger">*</span></label>
								<div class="col-sm-4">
									<input type="text" name="nis" class="form-control" id="nis" autocomplete="off" required>
								</div>
							</div>
							<div class="mb-2 row">
								<label for="nama_siswa" class="col-sm-2 col-form-label">Nama Siswa<span class="text-danger">*</span></label>
								<div class="col-sm-4">
									<input type="text" name="nama_siswa" class="form-control" id="nama_siswa" autocomplete="off" required>
								</div>
							</div>
							<div class="mb-2 row">
							...
							<div class="mb-2 row">
								...
								<div class="col-sm-4">
									<input type="text" name="angkatan" class="form-control" autocomplete="off" id="alamat" required>
								</div>
							</div>
							<div class="mb-2 row">
